...
""".format(otp)
    ...
    server.login('navalinikku@gmail.com', 'ellt yzkm xzia ycgu')
...
def subscribe():
    if request.method == 'POST':
        ...
        # Example: data = request.form['data']
        # Redirect back to the student dashboard page after handling the POST request
        return redirect(url_for('subscribed.html'))
...
def send_new_course_email( email_content):
    email_address = 'navalinikku@gmail.com'  # Your Gmail email address
    app_password = 'ellt yzkm xzia ycgu'  # Your app-specific password
...
def start_npm():
    try:
        ...
        frontend_project_path = r'C:\Users\naval\OneDrive\Desktop\Online'
